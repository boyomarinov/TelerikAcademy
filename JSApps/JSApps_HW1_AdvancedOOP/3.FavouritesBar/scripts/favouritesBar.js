...
var FavoriteSiteBar = Class.create({
    ...
    _displaySetOfFolders: function () {
        ...
        for (var i = 0; i < folders.length; i++) {
            ...
            paragraph.className = "favouritesParagraph";
